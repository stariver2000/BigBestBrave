...
| # | 논문 | 학회 | 페이지로 옮길 것 |
| --- | --- | --- | --- |
| 1 | GhostUI: Unveiling Hidden Interactions in Mobile UI | CHI 2026 (SNU) | 숨은 상호작용의 갈래를 만져 보는 화면 |
| 2 | Good Fences Make Good Learning: How Self-Directed Language Learners Navigate LLM Delegation Decisions | CHI 2026 (SNU) | 무엇을 맡기고 무엇을 스스로 할지의 울타리 |
| 3 | Chillbot: Content Moderation in the Backchannel | CSCW 2024 (KAIST) | 뒷무대에서 이루어지는 조정 |
| 4 | Beyond Instructions: A Taxonomy of Information Types in How-to Videos | CHI 2023 (KAIST) | 하우투 영상 속 정보의 갈래 |
